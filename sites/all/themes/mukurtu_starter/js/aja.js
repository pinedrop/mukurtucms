  ...
  $('area').tooltipster({
    ...
    functionBefore: function(instance, helper) {
      ...
      if ($origin.data('loaded') !== true) {
        ...
        $.get('http://178.128.54.20:8983/solr/ajafiles/select?q=bow:"' + query + '"&rows=20&facet=true&facet.field=bow_personal&facet.field=bow&facet.mincount=1&facet.bow_personal.facet.limit=5&facet.bow.facet.limit=7&facet.sort=count', function(data) {
