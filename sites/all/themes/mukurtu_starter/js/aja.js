  ...
  $('area').tooltipster({
    ...
    functionBefore: function(instance, helper) {
      ...
      if ($origin.data('loaded') !== true) {
        ...
        $.get('http://178.128.54.20:8983/solr/ajafiles/select?q=bow:"' + query + '"&rows=20&facet=true&facet.field=bow_personal&facet.field=bow&facet.mincount=1&facet.limit=5&facet.sort=count', function(data) {
